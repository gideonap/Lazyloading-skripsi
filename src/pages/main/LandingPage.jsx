    ...
    <Suspense fallback={<div>Loading Page...</div>}>
        ...
        <div className='flex flex-col gap-16'>
            ...
            <div
                ...
                <div
                    className={`relative flex flex-col items-center lg:items-start justify-center lg: gap-5 w-72 lg:w-fit text-white h-full z-10 transition-opacity duration-1000 opacity-100`}> {/* Always visible */}
                    ...
                    <Button
                        onClick={() => handleNavigateToLink("/reservasi")}
                    >
                        Reservasi Sekarang
                    </Button>
                </div>
            ...
            <div className='flex flex-col gap-24'>
                ...
                <LazySection>
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center'>
                            <img src="/images/background.JPG" alt="Bedengan view"
                                className='hidden lg:block rounded-lg h-72 w-auto' loading="lazy"/>
                    ...
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center'>
                            <div className='flex flex-col gap-9 items-center lg:items-start'>
                                ...
                                <Button
                                    onClick={() => handleNavigateToLink("/syarat-dan-ketentuan")}
                                >
                                    Cek Syarat dan Ketentuan
                                </Button>
                            </div>
                            <img src="/images/cuate.png" alt="Terms illustration"
                                className='hidden lg:block rounded-lg h-72 w-auto' loading="lazy"/>
                        </div>
                    </div>
                </LazySection>
                ...
                <LazySection>
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-24 items-center'>
                            {/* Warung */}
                ...
                <LazySection>
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex flex-col gap-8 lg:flex-row px-10 lg:px-28 lg:gap-10 items-center'>
                            <img src="/images/PetaBedengan.jpeg" alt="Map of Bedengan Campsite"
                                className='h-96 w-auto rounded-lg' loading="lazy"/>
                        </div>
                    </div>
                </LazySection>
                ...
                <LazySection>
                    <div className='flex flex-col gap-8 items-center'>
                        ...
                        <div className='flex w-fit flex-col px-10 lg:px-28 gap-10 lg:gap-16 items-center'>
                            <img src="/images/background.JPG" alt="Testimonial person" className='rounded-full h-32 w-32 object-cover' loading="lazy"/>
                            <div className='flex flex-col relative gap-5 lg:px-48 items-center text-center'>
                                <img src='/images/quoteicon.svg' alt="Quote icon"
                                    className='absolute hidden lg:block lg:top-[-3.5rem] lg:left-32 lg:h-14 lg:w-auto opacity-15' loading="lazy"/>
                                <p>"Temukan kedamaian dan keindahan alam di jantung Bedengan dengan pengalaman berkemah
                                    yang tak terlupakan. Pilih dari berbagai lokasi perkemahan yang mempesona. nikmati
                                    fasilitas modern, dan rasakan ketenangan jauh dari hiruk-pikuk kota. Mulai
                                    petualangan Anda hari ini dengan mudah - cari tanggal, pilih lokasi, dan buat
